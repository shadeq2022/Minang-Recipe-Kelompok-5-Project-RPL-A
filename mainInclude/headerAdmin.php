...
<!-- SIDEBAR -->
  <div class="d-flex flex-column flex-shrink-0 p-4 bg-body-tertiary" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li>
        <a href="adminDashboard.php" class="nav-link <?php if ($currentPage === 'dashboard') echo 'active';?>">
      ...
      <li>
        <a href="kelolaResep.php" class="nav-link <?php if ($currentPage === 'kelolaResep') echo 'active'; ?>" aria-current="page">
      ...
      <li>
        <a href="users.php" class="nav-link <?php if ($currentPage === 'users') echo 'active'; ?>" aria-current="page">
      ...
      <li>
        <a href="adminLaporan.php" class="nav-link <?php if ($currentPage === 'laporan') echo 'active'; ?>" aria-current="page">
      ...
      <li>
        <a href="adminUbahPass.php" class="nav-link <?php if ($currentPage === 'adminUbahPass') echo 'active'; ?>" aria-current="page">

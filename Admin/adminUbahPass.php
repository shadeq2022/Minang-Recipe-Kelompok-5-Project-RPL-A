...
//inisialisasi variabel $adminEmail yang diambil dari session 
$adminEmail = $_SESSION['adminLogemail'];
    ...
    <div class="row mb-3">
        <div class="col-lg-12">
                    ...
                    <div class="container-fluid mt-4 px-5" id="container-wrapper">
                        ...
                        <div class="col-lg-12">
                            ...
                            <strong class="strong-pri"><label for="inputnewpassword" class="form-label">Password
                                    Baru:</label></strong>
                            <input type="text" class="form-control mb-4" name="admin_pass" id="inputnewpassword"
                                required>
            ...
            <div class="card-footer text-center">
                <button type="submit" class="btn btn-primary mt-4 mb-3" id="adminPassUpdateBtn"
